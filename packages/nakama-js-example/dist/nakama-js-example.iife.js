(() => {
  ...
  var Client = class {
    constructor(serverkey = DEFAULT_SERVER_KEY, host = DEFAULT_HOST, port = DEFAULT_PORT, useSSL2 = false, timeout = DEFAULT_TIMEOUT_MS) {
      this.serverkey = serverkey;
      this.host = host;
      this.port = port;
      this.useSSL = useSSL2;
      this.timeout = timeout;
      const scheme = useSSL2 ? "https://" : "http://";
    ...
    createSocket(useSSL2 = false, verbose = false, adapter = new WebSocketAdapterText()) {
      return new DefaultSocket(this.host, this.port, useSSL2, verbose, adapter);
    }
